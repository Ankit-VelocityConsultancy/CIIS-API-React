...
const SetExamination = () => {
    ...
    const setExamPermission = userPermissions?.setexam || {};
    ...
    const handleDownload = () => {
      ...
      useEffect(() => {
          if (setExamPermission.add === 0 && setExamPermission.view === 1) {
  ...
  // Set Examination
    ...
    <div className="setexam-page">
              ...
              {(setExamPermission.add === 1 || setExamPermission.view === 1) && (
                <div className="flex">
                  {setExamPermission.add === 1 && (
                    <button
                      type="button"
                      className="bg-red-500 text-white py-2 px-4 m-4 rounded-md hover:bg-[#167fc7]"
                      onClick={() => setIsViewSetExamination(false)}
                    >
                      Set Examination
                    </button>
                  )}
                  {setExamPermission.view === 1 && (
                    <button
                      type="button"
                      className="bg-red-500 text-white py-2 px-4 m-4 rounded-md hover:bg-[#167fc7]"
                  ...
                  {setExamPermission.add === 1 && !isViewSetExamination && (
                 <>
                ...
                {setExamPermission.view === 1 && isViewSetExamination && (
                    <>
                  ...
                  {setExamPermission.add !== 1 && setExamPermission.view !== 1 && (
                      <div className="text-center text-red-600 font-bold text-lg mt-8">
